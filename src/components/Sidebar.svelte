...
<Sidebar>
	<SidebarWrapper class="bg-white" divClass="overflow-y-auto py-4 px-3 dark:bg-gray-800 bg-white rounded-none flex flex-col justify-between h-full border-r border-gray-200 dark:border-gray-700">
		<SidebarGroup>
